...
WebUI.click(findTestObject('Lister/Enable Lookup Link'))

WebUI.waitForElementVisible(findTestObject('Lister/Disable Lookup Link'), 0)

WebUI.verifyElementPresent(findTestObject('Lister/Disable Lookup Link'), 0)
